        ...
        <div class="d-flex justify-content-between align-items-start">
            <div>
                ...
                <p class="mb-0 opacity-75">
                    ...
                    @if($ticket->reply_at)
                        | Ответ дан {{ $ticket->reply_at->format('d.m.Y в H:i') }}
                    @endif
                </p>
            </div>
            <div class="text-end">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="timeline">
                        ...
                        @if($ticket->reply_at)
                            <div class="timeline-item">
                                <div class="text-muted small">{{ $ticket->reply_at->format('d.m.Y H:i') }}</div>
                    ...
                    <form method="POST" action="{{ route('admin.tickets.update-status', $ticket) }}">
                        ...
                        @else
                            <div class="alert alert-success">
                                ...
                                Заявка обработана {{ $ticket->reply_at->format('d.m.Y в H:i') }}
                            </div>
                        @endif
                    </form>
                </div>
